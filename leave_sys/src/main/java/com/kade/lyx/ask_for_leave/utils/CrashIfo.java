...
// *
// */
//public class CrashIfo implements Thread.UncaughtExceptionHandler {
//    private static final String TAG = "Activity";
//    private Context mContext;
//    private static final String SDCARD_ROOT = Environment.getExternalStorageDirectory().toString();
//    private static CrashIfo mInstance = new CrashIfo();
//
//
//    private CrashIfo(){}
//    /**
//     * 单例模式，保证只有一个CrashIfo实例存在
//     * @return
//     */
//    public static CrashIfo getInstance(){
//        return mInstance;
//    }
//
//    /**
...
//            File dir = new File(SDCARD_ROOT + File.separator + "CrashInfo" + File.separator);
//            if(! dir.exists()){
//                dir.mkdir();
//            }
//
